...
export const mocks = {
  ...
  // Suppliers (FF-1555)
  getSuppliers: mock(() => []) as MockFn,
  getSupplierById: mock(() => null) as MockFn,
  getSupplierRules: mock(() => []) as MockFn,
  getSupplierTransactions: mock(() => []) as MockFn,
  createSupplier: mock(() => ({})) as MockFn,
  updateSupplier: mock(() => ({})) as MockFn,
  deleteSupplier: mock(() => ({})) as MockFn,
  mergeSuppliers: mock(() => ({})) as MockFn,
  previewSupplierRule: mock(() => ({
    rows: [],
    total: 0,
    changing: 0,
  })) as MockFn,
  saveSupplierRule: mock(() => ({})) as MockFn,
  ...
  // Work types (FF-1607)
  getWorkTypes: mock(() => []) as MockFn,
  createWorkType: mock(() => ({})) as MockFn,
  updateWorkType: mock(() => ({})) as MockFn,
  reorderWorkTypes: mock(() => undefined) as MockFn,
  archiveWorkType: mock(() => ({})) as MockFn,
...
const dbQueriesMock = new Proxy(
  {
    ...
    getSupplierRules: mocks.getSupplierRules,
    getSupplierTransactions: mocks.getSupplierTransactions,
    createSupplier: mocks.createSupplier,
    updateSupplier: mocks.updateSupplier,
    deleteSupplier: mocks.deleteSupplier,
    mergeSuppliers: mocks.mergeSuppliers,
    previewSupplierRule: mocks.previewSupplierRule,
    saveSupplierRule: mocks.saveSupplierRule,
    ...
    getWorkTypes: mocks.getWorkTypes,
    createWorkType: mocks.createWorkType,
    updateWorkType: mocks.updateWorkType,
    reorderWorkTypes: mocks.reorderWorkTypes,
    archiveWorkType: mocks.archiveWorkType,
    restoreWorkType: mocks.restoreWorkType,
