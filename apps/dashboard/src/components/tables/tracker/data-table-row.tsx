...
export function Row({ children }: RowProps) {
  return (
    <TableRow className="group h-[45px] hover:bg-accent">{children}</TableRow>
  );
}
...
export function DataTableRow({ row, onDelete }: DataTableRowProps) {
  ...
  return (
    <AlertDialog>
      <DropdownMenu>
        <Row>
          <DataTableCell className="w-[420px] min-w-[420px] md:sticky md:left-0 bg-background group-hover:bg-accent z-20 border-r border-border before:absolute before:right-0 before:top-0 before:bottom-0 before:w-px before:bg-border after:absolute after:right-[-24px] after:top-0 after:bottom-0 after:w-6 after:bg-gradient-to-l after:from-transparent after:to-background group-hover:after:opacity-0 after:z-[-1]">
            <TrackerTimer
              projectId={row.id}
          ...
          <DataTableCell className="md:sticky md:right-0 bg-background group-hover:bg-accent z-30 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-px before:bg-border after:absolute after:left-[-24px] after:top-0 after:bottom-0 after:w-6 after:bg-gradient-to-r after:from-transparent after:to-background group-hover:after:opacity-0 after:z-[-1]">
