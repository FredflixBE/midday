...
export function OnboardingPage({
  ...
  return (
    <div className="h-screen overflow-hidden flex relative">
      ...
      {/* Left Side - Animation */}
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-muted items-center justify-center p-8 m-2">
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center p-8 lg:p-12 pt-10 dark:bg-background text-foreground">
