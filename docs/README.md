...
- **[quotes.md](./quotes.md)** - Design of quotes and proposals: quotes, versions and scenarios, products and rates, the pricing rules, the PDF, and the build order (FF-1606).
