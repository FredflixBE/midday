...
The steps are 1.2, 1.45 and 1.75 from the body for headings 3, 2 and 1, and 2.1 for a block's own title. That title used to be drawn at exactly an h1's size, in the editor and the PDF alike, so a section's title and a heading inside it were the same thing to look at. The scale this replaced stepped 1.11 from the body at the small end, and a heading 11% larger than the text under it is not a heading.
