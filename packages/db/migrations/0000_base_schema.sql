...
CREATE TYPE "public"."institution_status" AS ENUM('active', 'removed');--> statement-breakpoint
...
CREATE TYPE "public"."platform_provider" AS ENUM('slack', 'telegram', 'whatsapp', 'sendblue');--> statement-breakpoint
...
CREATE TYPE "public"."subscription_status" AS ENUM('active', 'past_due', 'trialing');--> statement-breakpoint
...
CREATE TABLE "platform_identities" (
	...
	"external_team_id" text DEFAULT '' NOT NULL,
	"external_channel_id" text,
	"metadata" jsonb,
	"created_at" timestamp with time zone DEFAULT now(),
	"updated_at" timestamp with time zone DEFAULT now(),
	CONSTRAINT "platform_identities_provider_external_unique" UNIQUE("provider","external_team_id","external_user_id")
);
--> statement-breakpoint
ALTER TABLE "platform_identities" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
CREATE TABLE "platform_link_tokens" (
	...
	"metadata" jsonb,
	"created_at" timestamp with time zone DEFAULT now(),
	CONSTRAINT "platform_link_tokens_code_unique" UNIQUE("code")
);
--> statement-breakpoint
ALTER TABLE "platform_link_tokens" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
CREATE TABLE "provider_notification_batches" (
	...
	"created_at" timestamp with time zone DEFAULT now(),
	"updated_at" timestamp with time zone DEFAULT now(),
	CONSTRAINT "provider_notification_batches_batch_key_unique" UNIQUE("batch_key")
);
--> statement-breakpoint
ALTER TABLE "provider_notification_batches" ENABLE ROW LEVEL SECURITY;--> statement-breakpoint
...
ALTER TABLE "platform_identities" ADD CONSTRAINT "platform_identities_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "platform_identities" ADD CONSTRAINT "platform_identities_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "platform_link_tokens" ADD CONSTRAINT "platform_link_tokens_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "platform_link_tokens" ADD CONSTRAINT "platform_link_tokens_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "provider_notification_batches" ADD CONSTRAINT "provider_notification_batches_identity_id_fkey" FOREIGN KEY ("platform_identity_id") REFERENCES "public"."platform_identities"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "provider_notification_batches" ADD CONSTRAINT "provider_notification_batches_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "provider_notification_batches" ADD CONSTRAINT "provider_notification_batches_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_inbox_display_name_trgm" ON "inbox" USING gin ("display_name" gin_trgm_ops);--> statement-breakpoint
...
CREATE INDEX "institutions_country_idx" ON "institutions" USING gin ("countries");--> statement-breakpoint
...
CREATE INDEX "invoices_team_due_date_idx" ON "invoices" USING btree ("team_id","due_date" DESC NULLS LAST) WHERE due_date IS NOT NULL;--> statement-breakpoint
CREATE INDEX "invoices_team_status_due_date_idx" ON "invoices" USING btree ("team_id","status","due_date" DESC NULLS LAST);--> statement-breakpoint
CREATE INDEX "invoices_team_customer_id_idx" ON "invoices" USING btree ("team_id","customer_id") WHERE customer_id IS NOT NULL;--> statement-breakpoint
CREATE INDEX "invoices_customer_id_idx" ON "invoices" USING btree ("customer_id") WHERE customer_id IS NOT NULL;--> statement-breakpoint
CREATE INDEX "invoices_team_created_at_idx" ON "invoices" USING btree ("team_id","created_at");--> statement-breakpoint
...
CREATE INDEX "platform_identities_provider_external_idx" ON "platform_identities" USING btree ("provider","external_team_id","external_user_id");--> statement-breakpoint
CREATE INDEX "platform_identities_team_id_idx" ON "platform_identities" USING btree ("team_id");--> statement-breakpoint
CREATE INDEX "platform_identities_user_id_idx" ON "platform_identities" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "platform_link_tokens_code_idx" ON "platform_link_tokens" USING btree ("code");--> statement-breakpoint
CREATE INDEX "platform_link_tokens_team_id_idx" ON "platform_link_tokens" USING btree ("team_id");--> statement-breakpoint
CREATE INDEX "platform_link_tokens_user_id_idx" ON "platform_link_tokens" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "provider_notification_batches_due_idx" ON "provider_notification_batches" USING btree ("sent_at","window_ends_at");--> statement-breakpoint
CREATE INDEX "provider_notification_batches_identity_idx" ON "provider_notification_batches" USING btree ("platform_identity_id");--> statement-breakpoint
CREATE INDEX "provider_notification_batches_team_id_idx" ON "provider_notification_batches" USING btree ("team_id");--> statement-breakpoint
...
CREATE INDEX "transaction_match_suggestions_team_status_created_idx" ON "transaction_match_suggestions" USING btree ("team_id" uuid_ops,"status" text_ops,"created_at" DESC NULLS LAST);--> statement-breakpoint
...
CREATE INDEX "idx_transactions_merchant_name_trgm" ON "transactions" USING gin ("merchant_name" gin_trgm_ops);--> statement-breakpoint
...
CREATE INDEX "idx_transactions_reports" ON "transactions" USING btree ("team_id" uuid_ops,"date" date_ops,"category_slug" text_ops) WHERE internal = false AND status != 'excluded';--> statement-breakpoint
...
CREATE POLICY "Activities can be selected by the user they belong to" ON "activities" AS PERMISSIVE FOR SELECT TO public USING ((user_id = auth.uid()));--> statement-breakpoint
...
CREATE POLICY "Documents can be selected by a member of the team" ON "documents" AS PERMISSIVE FOR ALL TO public USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
...
CREATE POLICY "Inbox can be selected by a member of the team" ON "inbox" AS PERMISSIVE FOR SELECT TO public USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Inbox can be updated by a member of the team" ON "inbox" AS PERMISSIVE FOR UPDATE TO public USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
...
CREATE POLICY "Team members can view their insights" ON "insights" AS PERMISSIVE FOR SELECT TO public USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
...
CREATE POLICY "Platform identities can be created by a member of the team" ON "platform_identities" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Platform identities can be selected by a member of the team" ON "platform_identities" AS PERMISSIVE FOR SELECT TO "authenticated" USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Platform identities can be updated by a member of the team" ON "platform_identities" AS PERMISSIVE FOR UPDATE TO "authenticated" USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Platform identities can be deleted by a member of the team" ON "platform_identities" AS PERMISSIVE FOR DELETE TO "authenticated" USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Platform link tokens can be created by a member of the team" ON "platform_link_tokens" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Platform link tokens can be selected by a member of the team" ON "platform_link_tokens" AS PERMISSIVE FOR SELECT TO "authenticated" USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Platform link tokens can be updated by a member of the team" ON "platform_link_tokens" AS PERMISSIVE FOR UPDATE TO "authenticated" USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Platform link tokens can be deleted by a member of the team" ON "platform_link_tokens" AS PERMISSIVE FOR DELETE TO "authenticated" USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Provider notification batches can be created by a member of the team" ON "provider_notification_batches" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Provider notification batches can be selected by a member of the team" ON "provider_notification_batches" AS PERMISSIVE FOR SELECT TO "authenticated" USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Provider notification batches can be updated by a member of the team" ON "provider_notification_batches" AS PERMISSIVE FOR UPDATE TO "authenticated" USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Provider notification batches can be deleted by a member of the team" ON "provider_notification_batches" AS PERMISSIVE FOR DELETE TO "authenticated" USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
...
CREATE POLICY "Transactions can be deleted by a member of the team" ON "transactions" AS PERMISSIVE FOR DELETE TO public USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Transactions can be selected by a member of the team" ON "transactions" AS PERMISSIVE FOR SELECT TO public USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
CREATE POLICY "Transactions can be updated by a member of the team" ON "transactions" AS PERMISSIVE FOR UPDATE TO public USING ((team_id IN ( SELECT private.get_teams_for_authenticated_user() AS get_teams_for_authenticated_user)));--> statement-breakpoint
