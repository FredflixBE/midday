-- 10-storage.sql — the three buckets and who may reach into them.
--
-- Run after `drizzle-kit push`: the team policies call
-- private.get_teams_for_authenticated_user(), which 00-bootstrap.sql defines
-- but which reads users_on_team, a table the push creates.
--
-- Idempotent: buckets upsert, policies are dropped and recreated.
--
-- Policies recovered from the Supabase dump that lived at
