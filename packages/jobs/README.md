...
What did change is the warning's look-ahead: 24 hours to 48, in
`upcoming-notification.ts`. A daily run with a 24-hour window would warn about
almost nothing, because a series due 25 hours after one run is already an hour
away by the next.
